...
| 心跳协议 | `docs/agent-rules/heartbeat-protocol.md`（含 Git 安全约束第 10 条 + PR Manager 安全模式第 11 条） |
| 心跳指令模板 | `docs/agent-rules/heartbeat-templates.md`（含 Worktree 强制要求） |
