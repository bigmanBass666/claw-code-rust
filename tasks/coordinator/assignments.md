...
| TASK-010 | 修复 CJK 文本 panic（Issue #36） | Worker-001 | crates/provider/src/text_normalization.rs | assigned | 2026-04-19 | - |
| TASK-011 | 重新提取 Windows UNC path 修复为干净分支 | Worker-002 | crates/utils/src/home_dir.rs | assigned | 2026-04-19 | - |
| TASK-012 | 清理远程分支 | Worker-003 | - | assigned | 2026-04-19 | - |
