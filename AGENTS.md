...
2. AI 读取对应 Agent 的 `instructions.md`
3. AI 读取 `tasks/shared/standard-openings.md` 获取开场白
4. AI **以该 Agent 身份**输出开场白 + 当前状态摘要
5. AI **以该 Agent 身份**执行工作流程
6. 完成后以该 Agent 身份输出"请唤醒 [下一个Agent]" + 原因
7. 写入下一个 Agent 的 inbox（异步通知，非阻塞）
